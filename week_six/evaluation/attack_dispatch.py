"""
Per-step attack dispatch for TAIRO FetchReach-v4 benchmarks.
...
Source of truth
---------------
All logic is extracted verbatim from evaluation/episode_runner.py, which
is the validated sweep path.  record_videos.py's _apply_sensor_attack /
_apply_action_attack helpers replicated the same logic with hardcoded
magnitudes; those helpers are replaced by these shared functions.
...
def apply_sensor_attack(
    ...
    Returns:
        (policy_obs, updated_bias_vector, updated_goal_offset)
